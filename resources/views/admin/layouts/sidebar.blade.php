<div id="drawer-navigation"
    ...
    <div class="py-4 overflow-y-auto">
        <div class="flex mx-auto justify-center">
           <a href="{{route('dashboard.profile.edit')}}"> <img class="object-cover w-32 h-32 rounded-full my-8" src="{{ is_null(auth()->user()->picture) ? 'https://ui-avatars.com/api/?name=' . auth()->user()->name : getImage(auth()->user()->picture) }}"
            alt="{{auth()->user()->name}} photo"></a>
        </div>
